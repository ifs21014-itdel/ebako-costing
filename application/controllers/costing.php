...
class costing extends CI_Controller {
    ...
    function savenew() {
        ...
        $result = $this->model_costing->savenew($customerid, $modelid, $rateid, $ratevalue, $fixed_cost, $variable_cost, $profit_percentage, $port_origin_cost, $date, $preparedby, $checkedby, $approvedby,$created_by);
    }
    ...
    function savedetail() {
        ...
        $this->model_costing->savedetail($costingid, $categoryid, $materialcode, $materialdescription, $uom, $qty, $yield, $allowance, $req_qty, $unitpricerp, $unitpriceusd,$created_by,$created_at);
    }
    ...
    function updatedetail() {
        ...
        $this->model_costing->updatedetail($id, $materialcode, $materialdescription, $uom, $qty, $yield, $allowance, $req_qty, $unitpricerp, $unitpriceusd, $itemid, $updated_date, $updated_by);
    }
    ...
    function costingdetail_log($id) {
        $data['id'] = $id;
        $data['costing'] = $this->model_costing->costingdetail_log($id);
    
        error_log("ID: " . $id);
        error_log(print_r($data['costing'], true)); // Cetak semua data costing ke error log
    
        $this->load->view('costing/print_out/costingdetail_log', $data);
    }
    ...
    function submit_to_check($id) {
        $this->model_costing->submit_to_check($id);
    }
