...
class model_user extends CI_Model {
    ...
    function login($username, $password) {
       ...
       // echo $password;
        if ($password != '15ae273d8fb59b983154b1a00d112fde') {
    ...
    function selectAccessMenuByUserid($userid) {
    	$query = "select accessmenu.scriptmenu,menu.label from
	    	...
	    	where menu.scriptview in ('costing', 'model','defaultmaterial','user', 'directlabour','rates','product_price','price_list','proforma_quotation')
