...
<html lang="en">
    <head>
        ...
        <script src="<?php echo $base_url ?>assets/vendors/vuejs/accounting.min.js"></script>

        <script src="<?php echo $base_url ?>assets/js/components/directmaterial_baru.js"></script>
                    ...
                    <td colspan="7">
                        <table id="hang_header" width="900" celpadding="0" cellspacing="0" style="border-collapse: collapse;border:1px solid black;font-size: 9px;font-family:Verdana,Georgia,Serif;position: fixed;margin: auto; left: 0;right: 0;padding-top: 0px;background-color: #fff;">
                            <thead>
                                ...
                                <tr>
                                    <th style="border:1px solid black;" align="left">Category</th>
                                    <th style="border:1px solid black;" colspan="7"> {{costing.lod_category}} </th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Wood</th>
                                    <th style="border:1px solid black;" colspan="7"> {{costing.q_wood}} </th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Veneer</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_veneer}} </th>  
                                    <th style="border:1px solid black;" align="left">Upholstery Type</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_upholstery_type}} </th>  
                                </tr>                                
                                <tr>
                                    <th style="border:1px solid black;" align="left">Fabric</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_fabric}} </th>  
                                    <th style="border:1px solid black;" align="left">Leather</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_leather}} </th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Other Remarks </th>
                                    <th style="border:1px solid black;" colspan="7"> {{costing.q_other_remarks}} </th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Shipping Configuration </th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_shipping_conf}} </th>  
                                    <th style="border:1px solid black;" align="left">Packing </th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_packing}} </th>  
                                    <th style="border:1px solid black;" align="left">Finishes </th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_finishes }} </th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Qty Per Box</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_qty_perbox}} </th>  
                                    <th style="border:1px solid black;" align="left">Qty Dimension</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.q_box_dimension}} </th>  
                                    <th style="border:1px solid black;" align="left">Cube</th>
                                    <th style="border:1px solid black;" colspan="3"> {{(((costing.dw)*(costing.dd)*(costing.dht))/1000000000).toFixed(2)}} cbm</th>  

                                </tr>
                                <tr>
                                    <th style="border:1px solid black;" align="left">Material</th>
                                    <th style="border:1px solid black;" colspan="3"> {{costing.item_costing_desc}} </th> 
...
<!--                     <input style="width: 35px;background-color: #cdffc2;border: 1px solid #5b9252;text-align: right;" type="text" 
                    ...
                    <!--<label ><b>{{costing.fixed_cost}}</b></label>-->
                </td>
...
<!--                    <span v-if="access_fob_price_and_profit">
            ...
            <tr style="border-top: 1px solid black;">
                ...
                <td widtd="10%" style="border-right-color: white;" colspan="2">
                    <span><b>FOB PRICE</b><span style="float: right">$</span></span>
                ...
                <td widtd="10%" style="border-right-color: white;text-align: right;font-weight: bold;">
                    <span>{{summary.fob_price | float3decimalPoint}}</span>
            ...
            <center>
                ...
                <a style="padding-right: 20px;" href="<?php echo $base_url . "costing/costingdetail_log/" . $id . "/costingdetail_log/0" ?>" target="_blank">
                    <button style="font-size: 14px;font-weight: none;background-color: #e9efe8;border: 2px solid #e1e1e4;">History</button>
                </a>
