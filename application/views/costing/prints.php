                ...
                foreach ($costingcategory as $costingcategory) {
                    ...
                    foreach ($costingdetail as $result) {
                        ...
                        if (empty($result->yield) || $result->yield == 0)
                            $result->yield = 1;
                        //$req_qty = (($result->qty / $result->yield) * (1 + $result->allowance));
                        $req_qty = $result->req_qty;

                        //  $req_qty = $result->req_qty;
                        // echo "req qty=((".$result->qty."/".$result->yield.")*(1+".$result->allowance."))=".$req_qty."<br>";
                        //if( (empty($result->yield) || $result->yield <= 0 )  ){
                        ...
                        <tr>
                            ...
                            <td align="right" style="border:1px solid black;"><?php echo ($result->req_qty == 0) ? "" : number_format($result->req_qty, 3, '.', ''); ?></td>
...
//                                }
                            ...
                            <td align="right" style="border:1px solid black;"><?php echo number_format($unitpricerp); ?></td>
                            <td align="center" style="border:1px solid black;">
                                ...
                                echo number_format($unitpriceusd, 3, '.', '');
                                ?>
                            </td>            
                            <td align="right" style="border:1px solid black;">
                                <?php
                                //$total_in_usd = number_format(($unitpriceusd * $req_qty), 3, '.', ',');
                                $total_in_usd = round($unitpriceusd, 3) * $req_qty;
                                // echo "total in usd=".$unitpriceusd."*".$req_qty."<br>";
                                // $total_in_usd = ($unitpriceusd * $req_qty);
                                echo number_format($total_in_usd, 3);
                                ?>
                            </td>
...
// var_dump($costingcategorynotdirect);
                foreach ($costingcategorynotdirect as $costingcategory) {
                    ...
                    foreach ($costingdetail as $result) {
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid black;" align="center"><?php echo ($result->req_qty == 0) ? "" : number_format($result->req_qty, 3, '.', ''); ?></td>
                            ...
                            $unitpricerp = $result->unitpricerp;
                            if ($result->unitpriceusd != 0) {
                                $unitpricerp = $result->unitpriceusd * $ratevalue;
                            }
                            ?>
                        ...
                        <?php
                        //echo "subtotal=".$subtotal."+".$total_in_usd."<br>";
                        $subtotal = $subtotal + $total_in_usd;
                ...
                <tr style="border-top: 1px solid black;">
                    ...
                    <td widtd="8%" style="border-right-color: white;text-align: right;">
                        ...
                        <?php
                        echo 'round(('.$sum_not_direct[8].'x'.$costing->variable_mark_up_cat_8.'))';
