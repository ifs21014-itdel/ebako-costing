            ...
            foreach ($costing as $result) {
                ...
                <tr valign="top">
                    ...
                    <td>
                       ...
                       // echo "adadadas".$result->checkedstatus."<br>";
                        if ($result->checkedstatus != "") {
                            ...
                            if ($result->checkedstatus == 1) { //Approved
                                ...
                                <?php
                            } else if ($result->checkedstatus == 2) { //Pending
                                ?>
                    ...
                    <td>
                      ...
                      //  echo $this->session->userdata('id');
                        ...
                        if (empty($result->rateid)) {
                            ...
                            if ($result->locked == 'f' && $result->approvedstatus == '') {

                                // echo $result->locked."=".$result->approvedstatus;
                            ...
                            if (in_array('view_detail', $accessmenu)) {
                                if ($result->locked == 'f' && $result->approvedstatus == '') {
                                    //echo '<a href="' . base_url() . 'costing/edit_print_out/' . $result->id . '/print/0" target="alternative"><button class="btn btn-sm btn-success"> <i class="glyphicon glyphicon-search fa-sm"></i> View Detail</button> </a><br/>';
                                    echo "<button onclick=\"myFunction('".base_url() . "costing/edit_print_out/" . $result->id . "/print/0')\" class='btn btn-sm btn-success'> <i class='glyphicon glyphicon-search fa-sm'></i> View Detail</button><br/>";
                                }
                                if ($result->submit_to_check == 'f') {
                                    echo '<a href="javascript:submit_to_check(' . $result->id . ')"><button class="btn btn-sm btn-delete btn-danger"> Submit To Check</button> </a><br/>';
                                }
                            }
                            ...
                            if (in_array('print', $accessmenu)) {
                              //  echo '<a href="' . base_url() . 'costing/prints/' . $result->id . '/print/0" target="_blank"><button class="btn btn-sm btn-warning"> <i class="glyphicon glyphicon-print fa-sm"></i> Print</button> </a><br/>';
                                echo "<button onclick=\"myFunction('".base_url() . "costing/prints/" . $result->id . "/print/0')\" class='btn btn-sm btn-warning'> <i class='glyphicon glyphicon-print fa-sm'></i> Print</button><br/>";
                                ?>
                        <?php
                            }
                        ...
                        if ($result->locked == 't' || $result->approvedstatus == '1') {
                        ...
                        if (in_array('prints_cost_material_only_by_PRCH', $accessmenu)) {
                            //echo '<a href="' . base_url() . 'costing/prints_cost_material_only/' . $result->id . '/print/0" target="alternative"><button class="btn btn-sm btn-warning"> <i class="glyphicon glyphicon-print fa-sm"></i> Print Cost</button> </a><br/>';
                            echo "<button onclick=\"myFunction('".base_url() . "costing/prints_cost_material_only/" . $result->id . "/print/0')\" class='btn btn-sm btn-warning'> <i class='glyphicon glyphicon-print fa-sm'></i> Print Cost</button><br/>";
                        }
                        ?>
                    </td>
