        ...
        <div class="row">
            ...
            <div class="col-sm-6 table-toolbar-right">
                ...
                if (in_array('view_price_list', $accessmenu)) {
                    ...
                    echo '<a href="costing_pricereview/view_pricereview" target="blank"><button class="btn btn-labeled fa fa-search btn-primary"> Costing Price Review</button> </a>';
                    ?>

                    <a href="javascript:void(0)" onclick="App.loadTab('costing_review')">
                        <button class="btn btn-labeled fa fa-search btn-primary"> View Price Review</button>
                    </a>
                    <br>
                    <?php
                }
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="code_search" style="background-color: #f5faff; border: 1px solid #579ddb;" type="text" size="7" onkeypress="if (event.keyCode == 13) {
                                                        costing_search(0)
                                                    }">
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-2">
                                        ...
                                        <input class="form-control" type="text" size="7" name="custcode_search" id="custcode_search" style="background-color: #f5faff; border: 1px solid #579ddb;" onkeypress="if (event.keyCode == 13) {
                                                    costing_search(0)
                                                }"/>
                                    </div>
                                    <div class="form-group col-sm-2">
                                        <label for="custcode_search">Desc.</label> <input class="form-control" type="text" size="10" name="custdesc_search" id="custdesc_search" style="background-color: #f5faff; border: 1px solid #579ddb;" onkeypress="if (event.keyCode == 13) {
                                                    costing_search(0)
                                                }"/>
                                    </div>
                                    ...
                                    <label for="customerid_search">Status</label>
                                    <select class="form-control" id="approvedstatus_id" onchange="costing_search(0)" size="1" style="background-color: #f5faff; border: 1px solid #579ddb;">
                                        <option value="All">All</option>
                                        <option value="">Need To Approved</option>
