...
//                            }
                            $unitpricerp = $result->unitpricerp;
                            if ($result->unitpriceusd != 0) {
                                $unitpricerp = $result->unitpriceusd * $ratevalue_tmp;
                            }
                            ?>

                            <td style="border:1px solid black;" align="right"><?php echo number_format($unitpricerp); ?></td>
...
//                                }
//                                echo $unitpriceusd;
                                $unitpriceusd = ($result->unitpricerp / $ratevalue_tmp);
                                if ($result->unitpriceusd != 0) {
                                    $unitpriceusd = $result->unitpriceusd;
                                }
                                echo number_format($unitpriceusd, 3, '.', '');
