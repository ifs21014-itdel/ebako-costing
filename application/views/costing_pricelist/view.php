        ...
        <div class="panel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="end_ratevalue" class="form-control input-sm input-editable-pricelist" id="pricelist__end_ratevalue" value="12000" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="start_profit" class="form-control input-sm input-editable-pricelist" id="pricelist__start_profit" value="25" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="end_profit" class="form-control input-sm input-editable-pricelist" id="pricelist__end_profit" value="40" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-sm-7 control-label" for="range_ratevalue">Range</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="range_profit" class="form-control input-sm input-editable-pricelist" id="pricelist__range_profit" value="5" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-6 group__profit_range" style="display: none;">
                                            <div class="form-group">
                                                <label class="col-sm-7 control-label" for="profit_percentage">Rate Value</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="ratevalue" class="form-control input-sm input-editable-pricelist" id="pricelist__ratevalue" value="12000" required="required" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 group__rate_range" style="display: block;">
                                            <div class="form-group">
                                                <label class="col-sm-7 control-label" for="profit_percentage">Profit (%)</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="profit_percentage" class="form-control input-sm input-editable-pricelist" id="pricelist__profit_percentage" value="25" required="required" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input type="text" name="fixed_cost" class="form-control input-sm" id="pricelist__fixed_cost" value="11">
                                                </div>
                                            </div>
                                        </div>
                                    </div>	
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="variable_cost" class="form-control input-sm" id="pricelist__variable_cost" value="10">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">	
                                        ...
                                        <div class="col-sm-6">	
                                            <div class="form-group">
                                                <label class="col-sm-7 control-label" for="insurance_percentage">Insurance %</label>
                                                <div class="col-sm-4">
                                                    <input type="text" name="insurance_percentage" class="form-control input-sm" id="insurance_percentage_id" value="0" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row" style="margin-top: 0px;">
                <div class="col-sm-offset-2 col-sm-8">
                    <div class="panel-body">
                        <div class="form-group col-sm-2" style="padding-right: 1px">
                            <button class="btn btn-md btn-primary pull-right" onclick="costing_pricelist_search(0)">
                                <i class="fa fa-search"></i> View Price List
                            </button>
                        </div>
                        <div class="form-group col-sm-2" style="padding-left: 1px">
                            <button class="btn btn-md btn-warning pull-right" onclick="costing_pricelist_search_then_print_summary(0, 'pricelist')">
                                <i class="fa fa-print"></i> Price List
                            </button>
                        </div>
                        <div class="form-group col-sm-2" style="padding-left:1px">
                            <button class="btn btn-md btn-warning pull-right" onclick="costing_pricelist_search_then_print_summary(0, 'pricelist_p')">
                                <i class="fa fa-print"></i> Price List Project
                            </button>
                        </div>
                        <div class="form-group col-sm-2" style="padding-left: 1px">
                            <button class="btn btn-md btn-success pull-right" onclick="costing_pricelist_search_then_print_summary(0, 'quotation')">
                                <i class="fa fa-print"></i> Quotation
                            </button>
                        </div>
                        <div class="form-group col-sm-2" style="padding-left: 1px">
                            <button class="btn btn-md btn-success pull-right" onclick="costing_pricelist_search_then_print_summary(0, 'quotation_p')">
                                <i class="fa fa-print"></i> Quotation Project
                            </button>
                        </div>
                    </div>
                </div>
