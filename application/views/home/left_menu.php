                ...
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <?php if (array_key_exists('costing', $accessmenu)) { ?>
                            ...
                            <li>
                                <a href="javascript:void(0)" onclick="App.loadTab('sales_quotes')">
                                    <i class="psi-bar-chart"></i>
                                    <span class="menu-title">View Quotation</span>
                                </a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (array_key_exists('product_price', $accessmenu)) { ?>
                            <li>
                                <a href="javascript:void(0)" onclick="App.loadTab('product_price')">
                                    <i class="psi-split-vertical-2"></i>
                        ...
                        <?php if (array_key_exists('price_list', $accessmenu)) { ?>
                            <li>
                                <a href="javascript:void(0)" onclick="App.loadTab('price_list')">
                                    <i class="psi-split-vertical-2"></i>
                                    <span class="menu-title">Price List</span>
                                </a>
                            </li>
                        <?php } ?>
                        <?php if (array_key_exists('proforma_quotation', $accessmenu)) { ?>
                            <li>
                                <a href="javascript:void(0)" onclick="App.loadTab('proforma_quotation')">
                                    <i class="psi-split-vertical-2"></i>
                                    <span class="menu-title">Proforma Quotation</span>
                                </a>
                            </li>
                        <?php } ?>
