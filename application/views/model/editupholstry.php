<div style="width: 400px">
    <form id="form_edit_model_upholstry">
        <table width="100%" border="0" class="table_form">
            ...
            <tr>
                <td align="right"><span class="labelelement"><span style="color: red;">*&nbsp;</span> Yield</span></td>
                <td></td>
                <td><input type="text" size="4" id="model_uph_yield_id" name="yield" value="<?php echo $upholstery->yield ?>" style="text-align: center" /></td>
            </tr>
            <tr>
