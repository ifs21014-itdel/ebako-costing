...
<div style="height: 50%; width: auto; border-bottom: 4px #ddd inset" class="panel">
    ...
    <div class="panel-body" id="menu_content_model">
        <table width="100%" border="0">
                ...
                <td>
                    <div align="left" class="form-inline" style="padding-top: 2px;">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select class="form-control" id="customerid_search" onchange="model_search(0)" style="background-color: #f5faff; border: 1px solid #579ddb;">
                            ...
                            <select class="form-control" id="status_search_id" onchange="model_search(0)" style="background-color: #f5faff; border: 1px solid #579ddb;">
            ...
            <tr>
                <td>
                    <div id="modeldata" align="center" style="overflow-x: auto;width:auto;padding: 10px;">                    
                        <?php
                        $data['offset'] = $offset;
