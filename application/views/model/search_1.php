...
<table id="table_model" class="table table-striped table-bordered" cellspacing="0" >
    <thead>
    ...
    foreach ($model as $result) {
        ...
        <tr>
            ...
            <td onclick="model_viewdetail(<?php echo $result->id ?>)" ><?php echo $result->customername ?></td>
            ...
            <td>
                ...
                if ($result->approvedstatus != "") {
                    ...
                    if ($result->approvedstatus == 1) { //Approved
                        ...
                        <?php
                        echo "<br/><button onclick=model_approve(" . $result->id . ",'" . $result->checkedby . "',1,2,0)>Approve</button>&nbsp;";
                        echo "<button onclick=model_approve(" . $result->id . ",'" . $result->checkedby . "',3,2,0)>Reject</button>";
                    } else { //Reject
                        ?>
