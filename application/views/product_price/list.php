			...
			<tbody>
                ...
                ?>
                    <tr>
                        ...
                        <button type="button" class="btn btn-sm btn-success" 
                            onclick="select_quotation(<?php echo number_format($salesQuotes->fob_price, 2) ?>, <?php echo $salesId ?>)">
                            Pilih
                        </button>
                        </td>
                    </tr>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-sm btn-success" 
                            onclick="select_quotation(<?php echo number_format($quote->fob_price, 2) ?>, <?php echo $sales->id ?>)">
                            Pilih
                        </button>
                        </td>
                    </tr>
