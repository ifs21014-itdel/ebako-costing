    ...
    <div id="searchpricedata" style="padding: 10px;" class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            onclick="select_product_price_2('<?php echo $quote->fob ?>', '<?php echo $quote->id ?>','<?php echo $quote->customercode ?>','<?php echo $quote->ebako_code ?>')">
                            Select
                        </button>
                        </td>
                    </tr>
        ...
        <script type="text/javascript">
            ...
            function price_search(page) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url(); ?>index.php/proforma_quotation/search_product_price_2',
                    data: {
