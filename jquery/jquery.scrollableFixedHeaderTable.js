...
sfht = {};
function scrollableFixedHeaderTable(widthpx, heightpx, showSelect, cookie, headerRowSize,tableId) {
    ...
    $this.before('<table cellspacing="0" cellpadding="0" class="sfhtTable"><tr><td><div class="sfhtHeader"></div></td></tr><tr><td><div class="sfhtData" id="bvan_'+tableId+'" onscroll="my_scroll_position(this)"></div></td></tr></table>');
